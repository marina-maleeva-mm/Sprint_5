...
class TestLoginPage:
    ...
    def test_login_from_main_page_button_success(self, driver):
    ...
    def test_login_from_personal_account_button_success(self, driver):
        driver.get(Urls.MAIN_PAGE_URL)
    ...
    def test_login_from_registration_page_button_success(self, driver):
